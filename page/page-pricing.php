...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="">
      ...
      <title>HireMe by Tom - Pricing tables</title>
  ...
  <body class="nav-on-header smart-nav">
        ...
        <ul class="nav-menu">
          ...
          <li>
            ...
            <ul>
              ...
              <li><a class="active" href="page-pricing.html">Pricing</a></li>
    ...
    <header class="page-header bg-img size-lg" style="background-image: url(../assets/img/bg-banner2.jpg)">
      <div class="container no-shadow">
        ...
        <p class="lead text-center">We've got an awesome pricing table and package selection. You can have three or four package type.</p>
      </div>
    </header>
    <!-- END Site header -->
